...
import utils.dataset_util.graphxai_utils as gxai_utils
from utils.dataset_util.graphxai_utils.nx_conversion import match_torch_to_nx_edges, remove_duplicate_edges
from utils.dataset_util.graphxai_utils.misc import top_k_mask, threshold_mask
        ...
        if heat_by_exp:
            ...
            if self.edge_imp is not None:
                ...
                for j in ones_in_rmdup:
                    ...
                    trim_loc_mask = (trimmed_enc_subg_edge_index[0, :] == edge[0]) & (
                                trimmed_enc_subg_edge_index[1, :] == edge[1])
